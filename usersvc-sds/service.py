...
# Since we use the different namespace with kubernetes.default api, this 
# kubernetes token have not authorized to access kubernetes api, we should create a 
# new serviceaccout and clusterrole to authrize it
# hard code the non-secure api server address
ENDPOINT_URL_TEMPLATE = "http://172.17.8.101:8080/api/v1/namespaces/envoy-tutorial/endpoints/%s"
ENDPOINTS = {}
